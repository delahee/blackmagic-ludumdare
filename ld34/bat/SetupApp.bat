...
set CERT_NAME="DoubleKickHeroes"
set CERT_PASS=DoubleKickHeroesDoubleKickHeroes
set CERT_FILE="bat\DoubleKickHeroes.p12"
set SIGNING_OPTIONS=-storetype pkcs12 -keystore %CERT_FILE% -storepass %CERT_PASS%

:: Application descriptor
set APP_XML=application.axml

:: Files to package
set APP_DIR=bin\flash\bin
